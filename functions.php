...
function firetoss_seed_widgets_init() {
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer 2', 'firetoss_seed' ),
        'id'            => 'footer-2',
        'description'   => esc_html__( 'Add widgets here.', 'firetoss_seed' ),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget'  => '</section>',
...
// Add yours here following the below format
    ...
    wp_register_script( 'owl-autoHeight',  get_template_directory_uri() . '/js/owl.autoheight.js', false, false, true );
    wp_enqueue_script( 'owl-autoHeight',  get_template_directory_uri() . '/js/owl.autoheight.js', false, false, true );
    ...
    wp_register_script( 'modernizr-custom',  get_template_directory_uri() . '/js/modernizr-custom.js', false, false, true );
...
// Include and instantiate the class for Mobile Detect.
 ...
 * Custom functions that act independently of the theme templates.
 */
require get_template_directory() . '/inc/registrations.php';
